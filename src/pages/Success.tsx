...
export default function Success() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center pt-20 pb-24 px-6 relative overflow-hidden bg-emerald-950">
      <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1544254228-5e8e3a246985?q=80&w=2000')] bg-cover bg-center opacity-10 mix-blend-overlay"></div>
