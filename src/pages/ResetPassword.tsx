...
export default function ResetPassword() {
  ...
  const { verifyResetCode, confirmPasswordResetWithCode, resetPassword, openAuthModal } = useAuth();
          ...
          <div>
            <div className="text-center mb-8">
              ...
              <p className="text-sm text-neutral-600 font-sans">
                Create a new secure password for <strong className="text-neutral-900">{targetEmail}</strong>
              </p>
            </div>
